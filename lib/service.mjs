 ...
 * @param {{id:string, file:string, map?:string}|null} [opts.layoutBundle] Official layout bundle restored for Desktop advanced-mode phone access.
...
export function createPocketService({
  ...
  onTunnelReady,
  /** Desktop advanced mode layout bundle (null/omitted disables restore). */
  layoutBundle = null,
} = {}) {
