...
let __dshPocketLoc = new Proxy(window.location, { get: function (t, p) { if (p === 'hostname') return '127.0.0.1'; var v = t[p]; if (typeof v === 'function') return v.bind(t); return v; }, set: function (t, p, v) { t[p] = v; return true; } });
